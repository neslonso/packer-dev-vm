...
INSTALL_PRIVACY="${VM_INSTALL_PRIVACY}"
INSTALL_API_TOOLS="${VM_INSTALL_API_TOOLS}"
WELCOME_HTML="${VM_WELCOME_HTML}"

# SSH Keys and Post-provision commands (base64 encoded JSON)
SSH_KEY_PAIRS_JSON="${VM_SSH_KEY_PAIRS:-}"
POST_PROVISION_COMMANDS_JSON="${VM_POST_PROVISION_COMMANDS:-}"

# Disk encryption
DISK_ENCRYPTION_ENABLED="${VM_DISK_ENCRYPTION_ENABLED:-false}"
...
# LOGGING
# ==============================================================================
PROVISION_LOG="${HOME_DIR}/provision-${HOSTNAME}.log"
touch "$PROVISION_LOG"
