#!/bin/bash
# ==============================================================================
# PROVISION-UBUNTU.SH - Orquestador para Ubuntu Desktop (GNOME)
# ==============================================================================
# Este script coordina la ejecución de todos los módulos de provisioning
# para una VM con Ubuntu Desktop y GNOME.
# ==============================================================================
...
log_msg ""
log_msg "============================================================"
log_msg ">>> PROVISIONING UBUNTU DESKTOP (GNOME)"
...
# 13. Desktop GNOME + Aliases
log_section "13/15 Desktop GNOME"
...
# 14. RDP (GNOME Remote Desktop)
log_section "14/15 GNOME Remote Desktop"
...
log_msg ""
log_msg "Resumen:"
log_msg "  - Flavor: Ubuntu Desktop (GNOME)"
log_msg "  - Usuario: ${USERNAME}"
log_msg "  - Shell: ${SHELL_TYPE}"
